...
const I = ({ size = 20, color = 'currentColor', sw = 1.8, children, viewBox = '0 0 24 24', style }: { size?: number; color?: string; sw?: number; children: React.ReactNode; viewBox?: string; style?: React.CSSProperties }) => (
...
export const MessageCircleIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
  </I>
)

export const BookmarkIcon = ({ size = 20, color = 'currentColor', filled = false }: IconProps) => (
  <I size={size} color={color}>
    <path fill={filled ? color : 'none'} d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
  </I>
)

export const QuestionIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
...
export const ChatIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
  </I>
)
...
export const ChevronDownIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}><polyline points="6 9 12 15 18 9" /></I>
)
...
export const ThumbsUpIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
...
export const PaperclipIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48" />
  </I>
)

export const MicIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
...
export const SmileIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <circle cx="12" cy="12" r="10" />
...
export const TargetIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <circle cx="12" cy="12" r="10" />
...
export const TrophyIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <polyline points="8 8 12 2 16 8" />
    <rect x="8" y="8" width="8" height="6" />
    <path d="M8 14C8 17.3 9.5 20 12 22c2.5-2 4-4.7 4-8" />
    <path d="M6.5 8a4 4 0 0 1-4 4h-1" />
    <path d="M17.5 8a4 4 0 0 0 4 4h1" />
...
export const CheckIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}><polyline points="20 6 9 17 4 12" /></I>
)
...
export const StarIcon = ({ size = 20, color = 'currentColor', filled = false }: IconProps) => (
  <I size={size} color={color}>
    <polygon fill={filled ? color : 'none'} points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
  </I>
)
...
export const VideoIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
...
export const BookOpenIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
...
export const UserCircleIcon = ({ size = 20, color = 'currentColor' }: IconProps) => (
  <I size={size} color={color}>
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
    <circle cx="12" cy="7" r="4" />
    <circle cx="12" cy="12" r="10" strokeDasharray="none" />
  </I>
)
...
export function Avatar({ name, size = 40, bg }: { name: string; size?: number; bg?: string }) {
  ...
  return (
    <div style={{
      ...
      background: bg || 'linear-gradient(135deg, #FFC94A, #FF9A3C)',
